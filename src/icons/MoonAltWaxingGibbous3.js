...
const MoonAltWaxingGibbous3 = props => {
	...
	return (
		...
		>
			<path
				d="M3.74,14.44c0-2.03,0.5-3.91,1.51-5.64s2.37-3.1,4.1-4.1s3.61-1.51,5.64-1.51c1.52,0,2.98,0.3,4.37,0.89s2.59,1.4,3.6,2.4
...
MoonAltWaxingGibbous3.propTypes = {
	color: PropTypes.string,
	size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
}

MoonAltWaxingGibbous3.defaultProps = {
	color: '#000000',
	size: '30',
}
