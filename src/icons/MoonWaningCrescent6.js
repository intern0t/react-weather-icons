...
const MoonWaningCrescent6 = props => {
  ...
  return (
    ...
    >
      <path
        d="M3.74,14.44c0,2.04,0.5,3.93,1.51,5.65s2.37,3.1,4.09,4.1s3.61,1.51,5.65,1.51c-1.46-0.56-2.72-1.18-3.79-1.88
...
MoonWaningCrescent6.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
}

MoonWaningCrescent6.defaultProps = {
  color: '#000000',
  size: '30',
}
