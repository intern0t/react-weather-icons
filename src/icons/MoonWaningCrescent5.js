...
const MoonWaningCrescent5 = props => {
  ...
  return (
    ...
    >
      <path
        d="M3.74,14.44c0,2.04,0.5,3.93,1.51,5.65s2.37,3.1,4.09,4.1s3.61,1.51,5.65,1.51c-2.59-0.79-4.48-2.13-5.69-4.02
...
MoonWaningCrescent5.defaultProps = {
  color: '#000000',
  size: '30',
}
