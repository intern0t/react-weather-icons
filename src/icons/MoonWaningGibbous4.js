...
const MoonWaningGibbous4 = props => {
  ...
  return (
    ...
    >
      <path
        d="M3.74,14.47c0,1.52,0.3,2.98,0.89,4.37s1.39,2.58,2.4,3.59s2.2,1.8,3.59,2.4s2.84,0.89,4.37,0.89
...
MoonWaningGibbous4.defaultProps = {
  color: '#000000',
  size: '30',
}
