...
const MoonWaxingGibbous6 = props => {
  ...
  return (
    ...
    >
      <path
        d="M8.58,14.43c0,1.03,0.06,1.97,0.18,2.83s0.32,1.73,0.62,2.59s0.69,1.65,1.16,2.34s1.1,1.35,1.85,1.96s1.63,1.12,2.63,1.55
...
MoonWaxingGibbous6.defaultProps = {
  color: '#000000',
  size: '30',
}
